...
function Testing(props) {
    ...
    const [reserveAudio2, setreserveAudio2] = useState("");
    const [reserveAudio3, setreserveAudio3] = useState("");
    ...
    */
        ...
        const response = await API2.get(`/?key=${apikey}&hl=${langSubmit}&c=${apicodec}&f=${apiformat}&src=${part1}&b64=${apiB64Status}`);

        if (part2 !== "") {            
            response2 = await API2.get(`/?key=${apikey}&hl=${langSubmit}&c=${apicodec}&f=${apiformat}&src=${part2}&b64=${apiB64Status}`);
            setreserveAudio2(response2.data);

            if (part3 !== "") {
                response3 = await API2.get(`/?key=${apikey}&hl=${langSubmit}&c=${apicodec}&f=${apiformat}&src=${part3}&b64=${apiB64Status}`);
